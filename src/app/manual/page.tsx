        ...
        <div style={{ maxWidth: 860, margin: '0 auto', padding: '32px 24px', fontFamily: 'inherit', color: 'var(--text-primary)' }}>
            ...
            <Section id="attendance" title="2. 出勤職員の入力">
                ...
                <SubSection title="公休・年休・欠勤">
                    <p>各職種行の右側に数値入力欄があります。该当人数を数字で入力してください（職員名は不要）。</p>
                </SubSection>
            </Section>
            ...
            <Section id="nightrounds" title="5. 夜勤巡視サイン">
                <SubSection title="記録方法">
                    ...
                    <p>各時間帯のドロップダウンから巡視した職員を選択します。</p>
                    <p>ドロップダウンには、その日の夜勤者のうち各フロアに割り当てられた職員だけが表示されます。</p>
                </SubSection>
                <Caution>職員のフロア設定は「職員管理」ページの職種設定から行います。</Caution>
            </Section>
            ...
            <Section id="trouble" title="7. よくある質問・トラブル">
                ...
                <QA q="夜勤巡視のドロップダウンに職員が表示されない">
                    ①その日の出勤設定で「夜勤」に職員が選択されているか確認 ②職員管理で職種にフロア（1F/2F）が設定されているか確認
                </QA>
